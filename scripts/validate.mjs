...
for (const scriptName of ['doctor', 'validate', 'setup:demo', 'discover', 'plan', 'draft', 'intake', 'submit', 'status', 'tasks', 'runs', 'results', 'reconcile', 'resolve', 'collect', 'sweep', 'run-worker']) {
